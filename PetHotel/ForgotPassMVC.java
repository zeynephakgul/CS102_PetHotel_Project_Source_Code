...
/*
 * this is the viewer-model-controller class of the forgotPassword page
 * 
 * @author Alper Biçer
 */
...
public class ForgotPassMVC extends JPanel implements ActionListener {
	...
	int remainedSeconds;
	boolean isBack, isSubmitted, isMessageSent, isPageActive;
	...
	public ForgotPassMVC() {
		...
		// set the code
		codeForConfirmation = randomCodeGenerator();
	...
	public void actionPerformed( ActionEvent e ) {
		...
		if( remainedSeconds <= 0 && isPageActive ) {
		...
		if( e.getSource() == sendCode ) {
			...
			if( recipientAddress.length() <= 10 || !recipientAddress.substring( recipientAddress.length() - 10 ).equals( "@gmail.com" ) )
